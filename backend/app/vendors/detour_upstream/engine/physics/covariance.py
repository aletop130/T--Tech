...
# from app.vendors.detour_upstream.engine.config.settings import GM
...
from typing import Tuple
from math import isfinite
from app.vendors.detour_upstream.engine.config.settings import GM  # assuming this is Earth's GM constant
