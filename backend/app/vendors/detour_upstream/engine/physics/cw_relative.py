...
from app.vendors.detour_upstream.engine.config.settings import GM, ENGINE1_CW_SAMPLES
from app.vendors.detour_upstream.engine.physics.geometry import time_of_closest_approach
