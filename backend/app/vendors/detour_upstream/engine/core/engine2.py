...
from app.vendors.detour_upstream.engine.physics.forces import (
    NewtonianGravity,
    J2Perturbation,
    J3Perturbation,
    J4Perturbation,
...
from app.vendors.detour_upstream.engine.physics.solver_rk45 import RK45Solver
from app.vendors.detour_upstream.engine.physics.utils import specific_energy
from app.vendors.detour_upstream.engine.config.settings import COLLISION_RADIUS, DANGER_RADIUS
from app.vendors.detour_upstream.engine.core.engine1 import Engine1
...
class Engine2:
    ...
    def run_monte_carlo(self, satellite: Entity, debris: Entity, duration: float, N: int = 500, use_engine1_escalation: bool = False) -> Dict[str, Any]:
        ...
        use_cholesky = False
        try:
            from app.vendors.detour_upstream.engine.physics.covariance import make_spd
