      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-3">
            {[
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <span className="text-sm text-sda-text-muted">{service.uptime}</span>
                  <Tag intent={service.status === 'healthy' ? 'success' : 'warning'} minimal>
                    {service.status}
                  </Tag>
                </div>
              </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-sm text-sda-text-secondary">Enable AI-powered analysis</div>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-sm text-sda-text-secondary">Run hourly conjunction screening</div>
              </div>
              <Switch defaultChecked />
            </div>
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-sm text-sda-text-secondary">Receive space weather notifications</div>
              </div>
              <Switch defaultChecked />
            </div>
          </div>
        ...
        <Card elevation={Elevation.TWO} className="p-6">
          ...
          <div className="space-y-3">
            ...
            <Button icon="download" fill outlined onClick={handleDownloadReport} loading={loadingAction === 'report'}>
